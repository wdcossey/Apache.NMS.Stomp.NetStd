...
namespace Apache.NMS.Stomp
{
    ...
    public class Session : ISession, IDispatcher
    {
        ...
        [Obsolete("TransactionStartedListener not implemented.", true)]
        public event SessionTxEventDelegate TransactionStartedListener;

        [Obsolete("TransactionCommittedListener not implemented.", true)]
        public event SessionTxEventDelegate TransactionCommittedListener;

        [Obsolete("TransactionRolledBackListener not implemented.", true)]
